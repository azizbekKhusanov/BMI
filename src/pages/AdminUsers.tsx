  ...
  return (
    <Layout>
      <div className="container py-8 space-y-6">
        <div>
          <h1 className="text-3xl font-bold font-serif">Foydalanuvchilar</h1>
          <p className="text-muted-foreground mt-1">Foydalanuvchi ma'lumotlarini tahrirlash va rollarni belgilash.</p>
        </div>
